...
void main() {
  ...
  if( TDIV == 0 && mode == 1 ) {
    ...
    if (in_Position.x > 0){
      atomicAdd(gr[ind[TMOD].x].x, 1000000);
      atomicAdd(gr[ind[TMOD].x].y, 1000000);
    }

    if (in_Position.y > 0){
      atomicAdd(gr[ind[TMOD].y].x, 1000000);
      atomicAdd(gr[ind[TMOD].y].y, 1000000);
    }

    if (in_Position.z > 0){
      atomicAdd(gr[ind[TMOD].z].x, 1000000);
      atomicAdd(gr[ind[TMOD].z].y, 1000000);
    }
