...
void Delaunator::compute(std::vector<double>& in_coords){

  coords = in_coords;
  m_points.m_coords = in_coords;
...
Delaunator::Delaunator(std::vector<double> & in_coords):m_points(in_coords)
{
  compute(in_coords);
}
